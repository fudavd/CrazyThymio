            ...
            try:
                while True:
                    if time.time() - time_last >= 0.05:
                        ...
                        left = constant * (u + 0.025 - (w*2.75 / 2) * 0.085) / 0.021
                        right = constant * (u + 0.025 + (w*2.75 / 2) * 0.085) / 0.021
                        if np.isnan([u, w]).any():
                            left = 0.0
                            right = 0.0
                            raise ValueError
